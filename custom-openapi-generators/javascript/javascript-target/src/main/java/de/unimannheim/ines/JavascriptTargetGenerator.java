...
public class JavascriptTargetGenerator extends DefaultCodegen implements CodegenConfig {
    @SuppressWarnings("hiding")
    private final Logger LOGGER = LoggerFactory.getLogger(JavascriptTargetGenerator.class);
    ...
    public CodegenModel fromModel(String name, Schema model) {
        ...
        if (allDefinitions != null && codegenModel != null && codegenModel.parent != null && codegenModel.hasEnums) {
            ...
            codegenModel = JavascriptTargetGenerator.reconcileInlineEnums(codegenModel, parentCodegenModel);
        }
    ...
    public Map<String, Object> postProcessOperationsWithModels(Map<String, Object> objs, List<Object> allModels) {
        ...
        // Custom extension
        Map<String, Object> results = objs;
