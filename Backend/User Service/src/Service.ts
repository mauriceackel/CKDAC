...
export class Service {
    ...
    public async start() {
        if (!this.running) {
            logger.info('Attempting start of user-service.');
    ...
    public async stop() {
        if (this.running) {
            ...
            logger.info('Attempting graceful shutdown of user-service.');
    ...
    private initRoutes(): void {
        if (this.express) {
            ...
            this.express.use(`/${Config.userEndpoint}`, UserController);
            this.express.use(`/${Config.validateEndpoint}`, ValidationController);
